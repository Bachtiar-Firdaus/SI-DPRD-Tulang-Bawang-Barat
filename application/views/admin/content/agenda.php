   			...
   			<div class="box">
   				...
   				<div class="box-body">
   					...
   					<section class="container-fluid" style="overflow-y: auto; overflow-x: scroll;">
   						<div class="dropdown">
   							<a href="<?php echo site_url() ?>/admin_controller/tambah_agenda"
   ...
   <script type="text/javascript">
   	...
   	$(document).ready(function () {
   		...
   		table = $('#table').DataTable({
   			...
   			"ajax": {
   				"url": "<?php echo site_url('admin_controller/ajax_list4')?>",
   				"type": "POST"
   			},
   	...
   	function edit_m_a(id) {
   		...
   		$.ajax({
   			url: "<?php echo site_url('admin_controller/ajax_edit4')?>/" + id,
   			type: "GET",
   			dataType: "JSON",
   			success: function (data) {
   				...
   				if (data.photo) {
   					...
   					$('#photo-preview div').append('<input type="checkbox" name="remove_photo" value="' +
   	...
   	function save() {
   		...
   		if (save_method == 'add') {
   			url = "<?php echo site_url('admin_controller/ajax_add4')?>";
   		} else {
   			url = "<?php echo site_url('admin_controller/ajax_update4')?>";
   		}
   	...
   	function delete_m_a(id) {
   		if (confirm('Are you sure delete this data?')) {
   			// ajax delete data to database
   			$.ajax({
   				url: "<?php echo site_url('admin_controller/ajax_delete4')?>/" + id,
   				type: "POST",
   				dataType: "JSON",
   				success: function (data) {
   							...
   							<div class="col-md-12">
   								<section class="content">
   									<div class="row">
   										<div class="box">
   											<div class="box-header">
   												<h3 class="box-title">Edit Agenda
   												</h3>
