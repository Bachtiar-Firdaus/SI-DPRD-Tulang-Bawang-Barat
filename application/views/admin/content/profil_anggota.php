...
<link href="<?php echo base_url('assets/bootstrap-datepicker/css/bootstrap-datepicker7.min.css')?>" rel="stylesheet">
		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<h7 class="box-title">PROFIL ANGGOTA</h7>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					...
					<section class="container-fluid" style="overflow-y: auto; overflow-x: scroll;">
						<div class="dropdown">
							...
							<a href="<?php echo site_url() ?>/admin_controller/tambah_profil"
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		table = $('#table').DataTable({
			...
			"ajax": {
				"url": "<?php echo site_url('admin_controller/ajax_list7')?>",
				"type": "POST"
			},
	...
	function edit_m_c(id) {
		...
		$.ajax({
			url: "<?php echo site_url('admin_controller/ajax_edit7')?>/" + id,
			type: "GET",
			dataType: "JSON",
	...
	function save() {
		...
		if (save_method == 'add') {
			url = "<?php echo site_url('admin_controller/ajax_add7')?>";
		} else {
			url = "<?php echo site_url('admin_controller/ajax_update7')?>";
		}
	...
	function delete_m_c(id) {
		if (confirm('Are you sure delete this data?')) {
			// ajax delete data to database
			$.ajax({
				url: "<?php echo site_url('admin_controller/ajax_delete7')?>/" + id,
				type: "POST",
				dataType: "JSON",
				success: function (data) {
			...
			<div class="modal-body form">
				<form action="#" id="form" class="form-horizontal">
					...
					<div class="form-group" style="padding: 10px;">
						...
						<div class="input-group" id="photo-preview">
							<label>Photo</label>
							<div>
								(No photo)
							...
							<div class="col-md-12">
								<section class="content">
									<div class="row">
										<div class="box">
											<div class="box-header">
												<h7 class="box-title">PROFILE ANGGOTA
												</h7>
