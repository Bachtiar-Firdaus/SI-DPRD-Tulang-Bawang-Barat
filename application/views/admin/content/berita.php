...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		table = $('#table').DataTable({
			...
			"ajax": {
				"url": "<?php echo site_url('admin_controller/ajax_list6')?>",
				"type": "POST"
			},
	...
	function edit_m_b(id) {
		...
		$.ajax({
			url: "<?php echo site_url('admin_controller/ajax_edit6')?>/" + id,
			type: "GET",
			dataType: "JSON",
	...
	function save() {
		...
		if (save_method == 'add') {
			url = "<?php echo site_url('admin_controller/ajax_add6')?>";
		} else {
			url = "<?php echo site_url('admin_controller/ajax_update6')?>";
		}
	...
	function delete_m_b(id) {
		if (confirm('Are you sure delete this data?')) {
			// ajax delete data to database
			$.ajax({
				url: "<?php echo site_url('admin_controller/ajax_delete6')?>/" + id,
				type: "POST",
				dataType: "JSON",
				success: function (data) {
